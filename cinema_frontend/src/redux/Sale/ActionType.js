...
export const APPLY_SUMMER_SALE_REQUEST = "APPLY_SUMMER_SALE_REQUEST";
export const APPLY_SUMMER_SALE_SUCCESS = "APPLY_SUMMER_SALE_SUCCESS";
export const APPLY_SUMMER_SALE_FAILURE = "APPLY_SUMMER_SALE_FAILURE";