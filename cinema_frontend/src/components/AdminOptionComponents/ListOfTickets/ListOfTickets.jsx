    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className="border rounded-lg overflow-hidden">
                <div className='grid grid-cols-[1fr_2fr_1fr_1fr_1fr_1fr_1fr] bg-gray-100 font-bold px-4 py-2'>
                    <div>ID</div>
                    <div>User email</div>
                    <div>Hall name</div>
                    <div>Status</div>
                ...
                {tickets.map(ticket => (
                    <div key={ticket.id} className="grid grid-cols-[1fr_2fr_1fr_1fr_1fr_1fr_1fr] border-t px-4 py-2 items-center">
                        <div>{ticket.id}</div>
